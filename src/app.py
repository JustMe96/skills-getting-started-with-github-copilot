...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice drills and play friendly matches against other schools",
        "schedule": "Tuesdays and Thursdays, 5:00 PM - 6:30 PM",
        "max_participants": 22,
        "participants": ["natalie@mergington.edu", "samuel@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Develop basketball skills and teamwork through scrimmages",
